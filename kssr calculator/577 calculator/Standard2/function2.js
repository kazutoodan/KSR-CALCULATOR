...
go.addEventListener("click",option);
  ...
  function addition()
  {
    ...
    {
    document.getElementById("message").innerHTML="cannot simplified this function because you will learn at standart 3"; 
    ...
    document.getElementById("message").innerHTML="The value are:"; 
    document.getElementById("UnDisTop").innerHTML=UnTopnum;
    document.getElementById("Divider").innerHTML="<hr>";
    document.getElementById("UnDisBot").innerHTML=UnBotnum;
